...
import com.myapp.model.CursoProfesor;
import com.myapp.service.*;


public class CursosProfesores implements ServicionInterface {
    ...
    public void guardarInformacion(CursoProfesor cp) {
        ...
        try (Connection cn = H2DB.getConnection()) {
            ...
            try (PreparedStatement psPersona = cn.prepareStatement(MERGE_PERSONA);
                ...
                psCP.setInt(3, cp.getAño());      // si tu getter es getAño(), cambia aquí
    ...
    public void cargarDatosDesdeBD() {
        ...
        try (Connection cn = H2DB.getConnection();
            ...
            while (rs.next()) {
                ...
                var profesor = new com.myapp.model.Profesor(
                ...
                com.myapp.model.Programa programaCurso = null;
                ...
                if (hayPrograma) {
                    ...
                    programaCurso = new com.myapp.model.Programa(
                        progId,                 // id
                ...
                var curso = new com.myapp.model.Curso(
                    rs.getInt(6),             // id
                ...
                var cursoProf = new com.myapp.model.CursoProfesor(
                    profesor,
                    rs.getInt(13),   // año
